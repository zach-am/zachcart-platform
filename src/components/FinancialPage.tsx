                            ...
                            <table className="w-full text-left text-sm">
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    <tr className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4"><span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs font-bold">Pending Payment</span></td>
                                    ...
                                    <tr className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4"><span className="bg-red-100 text-red-800 px-2 py-1 rounded-full text-xs font-bold">Overdue</span></td>
                                        <td className="px-6 py-4 text-gray-400">v</td>
                                    </tr>
                                    <tr className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4"><span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs font-bold">Paid</span></td>
                                        <td className="px-6 py-4 text-gray-400">v</td>
                                    </tr>
                                    {[2,3,4,5,6,7].map(i => (
